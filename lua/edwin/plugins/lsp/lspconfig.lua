return {
	...
	config = function()
		...
		mason_lspconfig.setup({
			ensure_installed = { "lua_ls", "ts_ls", "graphql", "emmet_ls" },
		})

		-- Keymap utility for conciseness
		...
		local servers = { "ts_ls", "graphql", "emmet_ls", "lua_ls" }
		for _, server_name in ipairs(servers) do
			...
			elseif server_name == "ts_ls" then
				-- Special configuration for ts_ls (TypeScript)
